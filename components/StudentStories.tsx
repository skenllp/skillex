      ...
      <div className="mx-auto max-w-container">
        ...
        >
          {studentStories.map((s, i) => (
            <div
              key={i}
              className="group flex w-[300px] shrink-0 snap-start flex-col justify-between rounded-2xl border border-black/8 bg-light-gray/30 p-4 transition-all duration-300 hover:border-skill-green/50 hover:bg-white hover:shadow-xl hover:shadow-black/5 md:w-[330px]"
            >
              <div>
                ...
                <p className="mb-4 min-h-[72px] text-[13.5px] italic leading-relaxed text-charcoal/90">
                  &ldquo;{s.quote}&rdquo;
                </p>
              </div>
