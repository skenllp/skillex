...
export default function CareerJourney() {
  return (
    <section className="w-full bg-[#111111] px-5 py-8 text-white md:px-10 md:py-12 border-y border-white/5">
      <div className="mx-auto max-w-container text-center">
        <Reveal direction="up">
          ...
          <p className="text-[14.5px] text-white/65 max-w-[560px] mx-auto mb-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 text-left">
          {detailedSteps.map((s, i) => (
            <Reveal key={s.step} delay={i * 80} direction="up">
              <div className="group relative flex h-full flex-col justify-between rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 transition-all duration-300 hover:-translate-y-1 hover:border-skill-green/50 hover:bg-white/10">
                <div>
        ...
        <p className="mt-8 text-[13px] font-bold tracking-[0.25em] text-white/40 uppercase">
